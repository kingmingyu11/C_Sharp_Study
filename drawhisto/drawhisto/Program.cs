...

{
...

    {
...

        {
            ...
            for (int i = 0; i < rows; i++)  //행수 반복

            {

                byte hue = (byte)((float)i / rows * 180);       //색상계산

                hsv.At<Vec3b>(i, 0) = new Vec3b(hue, 255, 255); //hsv 컬러지정
            ...
            Cv2.CvtColor(hsv, bgrPalette, ColorConversionCodes.HSV2BGR);    //HSV->BGR변환
...

        {
            ...
            Mat image = Cv2.ImRead("C:\\Temp\\img\\ㅎㄹ.jpg", ImreadModes.Color);
